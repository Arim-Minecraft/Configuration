...
public class EffEliminateSounding extends Effect {
	...
	public String toString(@Nullable Event e, boolean debug) {
		return "arimsk eliminate sounding for " + player.toString(e, debug);
	}

	@Override
	protected void execute(Event e) {
		ArimLibPlugin.inst().packetSounds().cancelDefaultHitSound(player.getSingle(e));
	}
